...
<div class="row row-offcanvas row-offcanvas-right">
	<div class="row">
		...
		<div class="bs-example" style="margin-top: 5px">
			<form name="formColecao" method="post"
				action="colecao/gravar-colecao-rapida.php">
				...
				<div class="row">
					<div class="col-sm-6 col-md-4">
						<div class="thumbnail">
							...
							<div class="caption">
								<div class="input-group">
									<textarea rows="11" cols="45" name="arrayPortugues" required="required"
										style="text-align: left;"><?php echo $arrayPortugues?></textarea>
								</div>

								Tipo de questão:<br /> <input type="radio" name="contido"
									value="0" <?php if ($contido == 0) echo "checked"?> /> O
								elemento está contido na seleção<br /> <input type="radio"
									name="contido" value="1"
									<?php if ($contido == 1) echo "checked"?> /> O elemento não
								está contido na seleção
								
								<div class="input-group">
									<span class="input-group-addon" style="width: 50px">Resposta: <?php 
									if (!$resposta_correta)
										$resposta_correta = 1;
		...
		<span class="input-group-addon" style="width: 50px;"><span style="color:#EEE">Resposta:</span>';
									}
									?> <input type="radio" name="resposta_correta"
										value="<?php echo $x?>"
										<?php if ($resposta_correta == $x) echo "checked"?>> Item <?php echo $x?>
										<?php }   ?>
					...
					<div class="col-sm-6 col-md-4">
						<div class="thumbnail">
							...
							<div class="caption">
								...
								<div class="input-group">
									<textarea rows="11" cols="45" name="arrayIngles" required="required"
										style="text-align: left;"><?php echo $arrayIngles?></textarea>
								</div>
					...
					<div class="col-sm-6 col-md-4">
						<div class="thumbnail">
							...
							<div class="caption">
								...
								<div class="input-group">
									<textarea rows="11" cols="45" name="arrayEspanha"
										required="required" style="text-align: left;"><?php echo $arrayEspanha?></textarea>
								</div>
				...
				<p align="center" style="padding-top: 10px">
					<button type="submit" class="btn btn-default">
						<?php echo $acao == "a" ? "Alterar" : "Salvar"?>
						Coleção
					</button>
